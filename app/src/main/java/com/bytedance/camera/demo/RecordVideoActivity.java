    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_picture).setOnClickListener(v -> {
            if (ContextCompat.checkSelfPermission(RecordVideoActivity.this,
                ...
                //todo 在这里申请相机、存储的权限
                ActivityCompat.requestPermissions(RecordVideoActivity.this, mPermissionsArrays, REQUEST_VIDEO_CAPTURE);
            } else {
                //todo 打开相机拍摄
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        switch (requestCode) {
            case REQUEST_EXTERNAL_CAMERA: {
                //todo 判断权限是否已经授予
                Toast.makeText(RecordVideoActivity.this, "权限申请成功", Toast.LENGTH_LONG).show();
                break;
            }
        }
    }
